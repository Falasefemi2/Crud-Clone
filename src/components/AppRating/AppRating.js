...
const getIosPrefix = () => {
   return <img src="https://web-images.credcdn.in/_next/assets/images/home-page/apple-store-logo.png" alt=""  className='app-rating-icon'/>
}
    ...
    <div className='max-width flex app-rating'>
        <div className="app-rating-block flex flex-col">
            <div className="flex">
                ...
                <img src="https://web-images.credcdn.in/_next/assets/images/home-page/rating-ios.png" alt="" className='app-rating-stars' />
                </div>
        ...
        <div className="app-rating-block flex flex-col">
            <div className="flex">
                ...
                <img src="https://web-images.credcdn.in/_next/assets/images/home-page/rating-android.png" alt="" className='app-rating-stars' />
                </div>
                <div className='app-rating-platform'>
                    play <br /> store
                </div>
